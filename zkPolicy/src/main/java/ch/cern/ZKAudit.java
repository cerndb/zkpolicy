...
public class ZKAudit {
     ...
     * @param auditConfigFile File that defines the queries to be executed for this particular audit report
     ...
     * @throws InterruptedException
     */
    public String generateHumanReadableAuditReport() throws JsonParseException, JsonMappingException,

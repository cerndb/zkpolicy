...
public class ZKTree {
  ...
  /**
   * A ZooKeeper instance that provides access to the ZNode tree.
   * @param zk Zookeeper Client Object.
   * @param config Zookeeper configuration object.
   */
  ...
  private void queryTreeIntParentYesChildNo(List<String> output, String path, String indent, String name,
                                            ZKQuery query, String[] optionArgs, List<ACL> parentACLList)
   ...
   * Recursive function that constructs the full ZNode tree.
   *
   * @param output Output list with th ZK tree.
   */
